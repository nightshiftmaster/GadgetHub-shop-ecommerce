...
const ModalWindow = () => {
  ...
  return (
    <div className="h-screen  w-screen flex justify-center inset-0  items-center  backdrop-blur-sm fixed z-20">
      <div className="w-fit h-fit flex  md:gap-10 gap-5 justify-center flex-col items-center  shadow-2xl bg-white  rounded-xl border-slate-300 border">
        <span
        ...
        <div className="flex gap-20 mb-8 text-sm md:text-base ">
          <button
            className="bg-blue-400 md:px-5 md:py-3 px-3 py-2 text-white rounded-md"
            onClick={() => {
          ...
          <button
            className="bg-gray-400  md:px-5 md:py-3 px-3 py-2  text-white rounded-md"
            onClick={() => {
              router.back();
            }}
          >
