...
const dataBase = data.map((item) => {
  switch (item.category) {
    case "mens-shoes":
    case "mens-shirts":
      item.generalCategory = "all for man";
      break;
    case "womens-shoes":
    case "womens-dresses":
    case "womens-bags":
    case "womens-jewellery":
      item.generalCategory = "all for women";
      break;
    case "home-decoration":
    case "furniture":
    case "lighting":
      item.generalCategory = "all for home";
      break;
    case "fragrances":
    case "skincare":
    case "groceries":
      item.generalCategory = "cosmetics";
      break;
    case "mens-watches":
    case "womens-watches":
      item.generalCategory = "watches";
      break;
    default:
      item.generalCategory = item.category;
      break;
  }
  return item;
});
